...
if [[ "$BGN" == "true" ]]; then
	...
	g++ -Ofast -march=native -std=c++14 -fno-rtti -fno-stack-protector -fno-exceptions -fwhole-program -DBOOKGEN -DNDEBUG -D_FORTIFY_SOURCE=0 src/combined.cpp -static -o ${EXENAME}_bookgen.exe
	echo "generating ..."
